...
export interface ApplicationNewFileHandler {
  action?: ApplicationFileEditor
  ext?: string
  menuTitle?: () => string
  routes?: RouteLocationRaw[]
}

export interface ApplicationFileEditor {
  app?: string
  extension?: string
...
export interface ApplicationInformationExtension extends ApplicationFileEditor {
  newFileMenu?: ApplicationNewFileHandler
  routes?: RouteLocationRaw[]
}
...
export interface ApplicationInformation {
  ...
  extensions?: ApplicationInformationExtension[]
